...
alter table ${prefix}ACT_RU_TASK
  ...
  references ${prefix}ACT_RE_PROCDEF;
...
alter table ${prefix}ACT_RU_VARIABLE
    ...
    references ${prefix}ACT_GE_BYTEARRAY;
