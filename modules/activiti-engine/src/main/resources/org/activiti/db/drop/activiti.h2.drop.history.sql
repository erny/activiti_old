...
alter table ${prefix}ACT_HI_PROCINST
    drop constraint ${prefix}ACT_UNIQ_HI_BUS_KEY;
    
drop table ${prefix}ACT_HI_PROCINST if exists;
drop table ${prefix}ACT_HI_ACTINST if exists;
drop table ${prefix}ACT_HI_TASKINST if exists;
drop table ${prefix}ACT_HI_DETAIL if exists;
drop table ${prefix}ACT_HI_COMMENT if exists;
drop table ${prefix}ACT_HI_ATTACHMENT if exists;
